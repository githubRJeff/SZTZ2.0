...
<div class="layout">
    ...
    <div class="section analysis">
        <div class="a-title">综合认定报表<div class="a-result">要求 <span class="a-request"><?php echo ($user[C('REQUIREDPOINT')]); ?></span> 学分，已修<span class="a-sum">0</span>分，还有<span class="a-count">0</span>个必修项未满要求</div></div>
    ...
    <div class="section report">
        ...
        <table class="table table-check-status a-table">
            ...
            <?php if(is_array($subjectReport)): $i = 0; $__LIST__ = $subjectReport;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="t-status"><?php echo ($vo['type']); ?></td>
